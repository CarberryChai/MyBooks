...
extension Book {
    private static let lastWeek = Calendar.current.date(byAdding: .day, value: -7, to: .now)!
    private static let lastMonth = Calendar.current.date(byAdding: .month, value: -1, to: .now)!
